...
<style>
    ...
    .import-section p { color: #666; font-size: 0.9rem; margin-bottom: 1rem; }
    .file-upload-controls { display: flex; gap: 1rem; align-items: center; }
    .btn-primary { background: #4f46e5; color: white; border: none; padding: 0.5rem 1rem; border-radius: 6px; cursor: pointer; }
    .btn-primary:disabled { background: #9ca3af; cursor: not-allowed; }

    .delete-section { margin-top: 2rem; padding-top: 2rem; border-top: 1px solid #fee2e2; }
    .delete-section p { color: #7f1d1d; font-size: 0.9rem; margin-bottom: 1rem; }
    ...
    :global(body.dark-mode) .delete-section { border-color: #7f1d1d; }
    :global(body.dark-mode) .import-section { border-color: #374151; }
    :global(body.dark-mode) .import-section h3 { color: #f3f4f6; }
    :global(body.dark-mode) .import-section p { color: #9ca3af; }
</style>
